...
export default function SiLarisScreen({ onBack }) {
  ...
  return (
    <div style={{display:'flex', flexDirection:'column', flex:1, overflow:'hidden', background:'#F9F9FB', height:'100%', position:'absolute', top:0, left:0, right:0, bottom:0, zIndex:300}}>
