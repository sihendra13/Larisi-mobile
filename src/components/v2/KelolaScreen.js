                ...
                <div style={{marginBottom:'16px'}}>
                  ...
                  <div style={{position:'relative'}}>
                    ...
                    <div style={{
                      ...
                      fontSize:'16px', 
                      fontWeight:'600', 
                      color: editDate ? (isGenZ ? '#fff' : 'var(--m-ink)') : (isGenZ ? '#9CA3AF' : '#9CA3AF'), 
                      ...
                      {editDate ? (function(){
                        ...
                        if(isNaN(d.getTime())) return editDate;
                        const mName = ['Jan','Feb','Mar','Apr','Mei','Jun','Jul','Ags','Sep','Okt','Nov','Des'];
                ...
                <div style={{marginBottom:'20px'}}>
                  ...
                  <div style={{position:'relative'}}>
                    ...
                    <div style={{
                      ...
                      fontSize:'16px', 
                      fontWeight:'600', 
                      color: editTime ? (isGenZ ? '#fff' : 'var(--m-ink)') : (isGenZ ? '#9CA3AF' : '#9CA3AF'), 
                      background: isGenZ ? '#1e1e24' : '#F9F9FA', 
                      boxSizing:'border-box',
                      textAlign:'left',
                      display: 'flex',
                      ...
                      {editTime ? editTime.replace(':', '.') : 'Pilih Waktu'}
                    </div>
                    {/* The Icon */}
                    <div style={{position:'absolute', left:'14px', top:'50%', transform:'translateY(-50%)', display:'flex', alignItems:'center', pointerEvents:'none', color: isGenZ ? '#9CA3AF' : 'var(--m-ink-sub)'}}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
