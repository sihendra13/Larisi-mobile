  ...
  return (
    <>
      ...
      <main style={{flex:1, overflowY:'auto', padding:'0 16px', paddingBottom:'calc(80px + env(safe-area-inset-bottom))'}}>
        ...
        {/* ── Ad Card 2 (Partial, as in mockup) ── */}
        <div style={{
          background:'#fff', border:'1px solid #E4E4EB', borderRadius:'20px',
          ...
          <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'12px'}}>
            <div style={{display:'flex', alignItems:'center', gap:'10px'}}>
              ...
              <div>
                <div style={{fontFamily:'var(--m-font)', fontSize:'15px', fontWeight:'800', color:'var(--m-ink)', marginBottom:'2px'}}>Reel Pondok Indah</div>
                <div style={{fontFamily:'var(--m-font)', fontSize:'12px', color:'var(--m-ink-sub)'}}>Jakarta</div>
              </div>
            </div>
            
            <div style={{display:'flex', alignItems:'center', gap:'8px'}}>
              <span style={{fontFamily:'var(--m-font)', fontSize:'10px', fontWeight:'800', color:'var(--m-ink-sub)', background:'#F5F5F7', padding:'3px 6px', borderRadius:'4px'}}>
                REEL
              </span>
              <div style={{
                background:'#E6F4EA', padding:'4px 10px', borderRadius:'99px',
